...
const nextConfig = {
  ...
  //       destination: '/home/index.html', // The path you want to redirect to
  //      // permanent: true, // Set to `true` if it's a permanent redirect (301), `false` for a temporary redirect (302)
  //     },
  //   ]
  // },
  images: {
    domains: ['xtendedspace.s3.ap-south-1.amazonaws.com','xtendedspacedev.blob.core.windows.net', 'xtendedspace.blob.core.windows.net'],
  },
  async headers() {
    return [
      {
    ...
    return [
      {
        ...
        // },
          ...
          // {
          //   source: '/services/household-relocation-ghaziabad',
          //   destination: '/packers-and-movers/ghaziabad',
          //   permanent: false,
          // },
          // {
          //   source: '/services/packers-movers-ghaziabad',
          //   destination: '/packers-and-movers/ghaziabad',
          //   permanent: false,
          // },
          {
          ...
          // {
          //   source: '/services/company-shifting-ghaziabad',
          //   destination: '/packers-and-movers/ghaziabad',
          //   permanent: false,
          // },
          {
          ...
          },
          {
            ...
            // {
            //   source: '/services/quick-pickup-ghaziabad',
            ...
            { source: '/insurance-coverage-lucknow', destination: '/storage-space/lucknow', permanent: true },
  { source: '/household-storage-lucknow', destination: '/storage-space/lucknow', permanent: true },
  { source: '/storage-solutions', destination: '/', permanent: false },
  { source: '/services/new-residence-relocation', destination: '/', permanent: false },
  ...
  { source: '/packers-and-movers-services', destination: '/services/packers-and-movers', permanent: true },
  { source: '/find-storage', destination: '/', permanent: false },
  { source: '/gurugram', destination: '/storage-space/gurugram', permanent: true },
  // { source: '/ghaziabad', destination: '/storage-space/ghaziabad', permanent: true },
  { source: '/faridabad', destination: '/storage-space/faridabad', permanent: true },
  { source: '/host', destination: '/', permanent: false },
  { source: '/HouseholdItems', destination: '/', permanent: false },
  { source: '/User/Listing/CreateListing/ListNewSpace', destination: '/', permanent: false },
  { source: '/Others', destination: '/', permanent: false },
  { source: '/FindStorage', destination: '/', permanent: false },
  { source: '/TermsConditions', destination: '/', permanent: false },
  { source: '/Noida', destination: '/storage-space/noida', permanent: true },
  // { source: '/Ghaziabad', destination: '/storage-space/ghaziabad', permanent: true },
  
  { source: '/demo1/dist/authentication/sign-in/basic.html', destination: '/', permanent: false },
  { source: '/Mumbai', destination: '/storage-space/mumbai', permanent: true },
  { source: '/cancellationpolicy', destination: '/', permanent: false },
  { source: '/Hyderabad', destination: '/storage-space/hyderabad', permanent: true },
  { source: '/FurnitureStorage', destination: '/', permanent: false },
  { source: '/privacypolicy', destination: '/privacy-policy', permanent: true },
  { source: '/Gurgaon', destination: '/storage-space/gurugram', permanent: true },
  ...
  { source: '/terms_and_conditions', destination: '/terms-and-conditions', permanent: false }, { source: '/easy-storage', destination: '/store-at-a-warehouse', permanent: false },
  { source: '/easy-storage', destination: '/store-at-a-warehouse', permanent: false },
  { source: '/affordable-storage', destination: '/store-with-a-host', permanent: false },
  {
