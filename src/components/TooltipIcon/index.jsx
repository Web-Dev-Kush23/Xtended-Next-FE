// components/TooltipIcon.jsx
import React from "react";

const TooltipIcon = ({ text }) => {
  return (
    <div className="easy-tooltip group ml-1 d-inline-flex cursor-pointer">
      <svg
        width="17"
        height="17"
        viewBox="0 0 17 17"
      ...
      <div className="absolute text-tooltip left-5 top-1/2 -translate-y-1/2 hidden group-hover:block w-64 p-2 bg-lime-500 text-white text-xs rounded-md shadow-lg z-10 w-full">
        {text}
      </div>
    </div>
  );
