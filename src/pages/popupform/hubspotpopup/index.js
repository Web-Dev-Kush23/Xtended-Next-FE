...
const Hubspot = ({ portalId, formId, hubspotFormSubmit, data, utm }) => {
    ...
    if (hubspotFormSubmit) {
        localStorageManager.setValue("currentPageUrl", JSON.stringify(data));
        ...
        if (iframe) {
            ...
            var phone = iframeDocument.getElementById(`phone-${formId}`);
