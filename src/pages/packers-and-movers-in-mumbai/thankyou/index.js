  ...
  return (
    <div className="packerWrapper">
      <section className="thanks">
        ...
        <p>
         We’ve received your request and our team will reach out to you shortly to discuss your Packers & Movers needs.
        </p>
        <Link className="thanks-btn" href="/services/packers-and-movers">Book By Yourself</Link>
