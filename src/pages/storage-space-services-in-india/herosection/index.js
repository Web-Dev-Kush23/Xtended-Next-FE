...
<img
      ...
      <section
        ...
        id="header"
        style={{
          backgroundImage: "url(https://xtendedspace.s3.ap-south-1.amazonaws.com/static/banners.jpg)"
        }}
      >
              ...
              <button
                ...
                className={
                  isBtnEnable && isChecked
                   ? `font-bold text-[20px] mb-4 bg-green-600 w-full h-auto py-10 rounded-lg animation-btn text-white `
                    : "disable-btn text-white mb-4 text-center w-full h-auto py-10 rounded-lg border-1px text-[20px] font-bold"
                }
              >
                Book Now
              </button>
        ...
        <div className="header-images">
            <div class="header-image">
              <Image
                ...
                alt="Business inventory storage service in Delhi"
                width={200}
                height={200}
              />
            </div>
            <div class="header-image">
              <img
                src="/images/delhi-images-storage-space/storage-space-stored-items/household-items-packing-service.webp"
                alt="household items packing service in Delhi"
              />
            </div>
            <div class="header-image">
              <img
                src="/images/delhi-images-storage-space/storage-space-stored-items/household-shifting.webp"
                alt="household items shifting in storage units"
              />
            </div>
            <div class="header-image">
              <img
                src="/images/delhi-images-storage-space/storage-space-stored-items/item-store-storage-facility.webp"
                alt="storage items doorstep pickup"
              />
            </div>
            <div class="header-image">
              <img
                src="/images/delhi-images-storage-space/storage-space-stored-items/lobour-move-items.webp"
                alt="labour moving items door to storage units"
              />
            </div>
            <div class="header-image">
              <img
                src="/images/delhi-images-storage-space/storage-space-stored-items/storage-unit-moving-items.webp"
                alt="Storage units Item stored image"
              />
            </div>
            <div class="header-image">
              <img
                src="/images/delhi-images-storage-space/storage-space-stored-items/storage-unit-storage-in-noida.webp"
                alt="home to storage unit in noida"
              />
            </div>
            <div class="header-image">
              <img
            ...
            <div class="header-image">
              <img
                src="/images/delhi-images-storage-space/storage-space-stored-items/three-layer-packing-storage-items.webp"
                alt="three layer packing for safety"
              />
            </div>
            <div class="header-image">
              <img
                src="/images/delhi-images-storage-space/storage-space-stored-items/storage-unit-stored-items-in-gurugram.webp"
                alt="storage unit stored items in gurugram"
              />
            </div>
          </div>
        </div>
