...
const Herosection = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    setHubspotFormSubmit(true);
          ...
          // router.push("/storage-space-facility-in-delhi-ncr/thankyou");
  ...
  return (
    <>
      <Hubspot
        portalId="45810273"
        formId="f231042d-e1f4-428d-bf0b-ca0f09af33cd"
      ...
      <section
        ...
        style={{
          backgroundImage:
            "url(https://xtendedspace.s3.ap-south-1.amazonaws.com/static/banners.jpg)",
        }}
      >
        ...
        <div className="header-content">
          <div className="header-title">
            <h1>Storage Facilities In Delhi NCR</h1>
